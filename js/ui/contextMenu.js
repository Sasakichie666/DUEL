...
// 修改：在 handleCardClick 中增加墓场/放逐区检索处理，并修正菜单项 value
                ...
                onSelect: (value) => {
                    ...
                    switch (value) {
                        ...
                        case 'equipCard':
                            ...
                            break;
                        // === 新增：墓场/放逐区检索（由卡牌点击触发时也能处理） ===
                        case 'searchGraveyard':
                            global.MenuAction?.searchGraveyard();
                            break;
                        case 'searchExile':
                            global.MenuAction?.searchExile();
                            break;
                        default:
            ...
            switch (zone) {
                ...
                case 'graveyard':
                    return [
                        ...
                        { label: '回手', value: 'returnToHand' },
                        { label: '检索', value: 'searchGraveyard' },
                        { label: '登场', value: 'playToFront' },
                        { label: '发动', value: 'activateToBack' },
                        { label: '装备', value: 'equipCard' },
                        { label: '回库', value: 'returnToDeck' }
