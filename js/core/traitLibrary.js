...
(function(global) {
    ...
    defineTrait('冻结', '这张卡直到下个回合结束，无法进行攻击，格挡以及发动效果', 'status');
    defineTrait('眩晕', '这张卡直到回合结束，无法进行攻击，格挡以及发动效果', 'status');
    ...
    defineTrait('禁锢', '这张卡直到下个回合结束，无法进行攻击，格挡', 'status');
    defineTrait('疲劳', '这张卡直到回合结束，无法进行攻击，格挡', 'status');
    ...
    defineTrait('增幅', '发动战术牌时，额外让对应的斌能回到斌能牌库底才能激活效果', 'effect');
    ...
    defineTrait('流转', '在墓场也可以发动效果，那之后放回牌库底', 'effect');
    defineTrait('通灵', '在墓场也可以发动效果，那之后放逐', 'effect');
    defineTrait('遗言', '进入墓场时触发效果', 'effect');
    defineTrait('强袭', '进入战场即可对对方主战者和随从发动攻击，不可被阻挡', 'effect');
    defineTrait('突进', '进入战场即可对对方随从发动攻击', 'effect');
    defineTrait('调律', '调律X,将手牌X张斌能以活跃状态放置于回响区，将回响区X张活跃状态费用放回牌库底', 'effect');
    defineTrait('穿透', '交战后破坏对方随从时给予对方主战者这张卡攻击力数值的伤害', 'effect');
    defineTrait('威慑', '这张卡不会成为发动攻击的对象', 'effect');
    defineTrait('援护', '休整状态也可以进行阻挡', 'effect');
    defineTrait('冥想', '从活跃状态切换至休整状态', 'effect');
    defineTrait('武装', '装备者可以获得效果', 'effect');
    defineTrait('结界', '发动后永续放置于战场后场', 'effect');
    // 可按需扩展
