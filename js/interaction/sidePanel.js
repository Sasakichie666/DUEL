...
(function(global) {
    ...
    function showRules() {
        const rules = [
            ...
            '7. 选择用随从对对方的随从发动进攻时，如果对方的随从是活跃状态，双方防御力减去对方的攻击力，数值为0的进入墓场。',
            '8.对方的随从是休整状态，对方随从防御力减去我方的攻击力，数值为0的进入墓场，对方需要承受攻击力超过防御力的数值伤害。回合结束时，战场存在的随从的防御力恢复为伤害计算前的数值。',
            '9. 当对方用随从进攻我方主战者时，你可以选择己方一名活跃状态的随从进行阻挡，你需要承受对方随从攻击力超过防御力的数值伤害。',
            '10. 传说卡牌的召唤只能使用活跃状态的斌能，并且支付完后让斌能回到牌库底。'
